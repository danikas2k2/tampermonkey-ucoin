...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.removeRowHrefFromSwapList = exports.ignoreUnwanted = exports.checkSold = exports.addConflictHandling = exports.showAllPrices = exports.duplicatePagination = exports.addOpenedTabsHandler = exports.addTrackingLinks = exports.addThumbnails = void 0;
const ajax_1 = __webpack_require__(759);
const cond_1 = __webpack_require__(290);
const delay_1 = __webpack_require__(799);
const url_1 = __webpack_require__(422);
function addThumbnails() {
    ...
    for (const row of document.querySelectorAll('table.swap-coin tr')) {
        const d = row.dataset;
        console.info(d);
        (_a = row.querySelector('td')) === null || _a === void 0 ? void 0 : _a.insertAdjacentHTML('beforebegin', `
